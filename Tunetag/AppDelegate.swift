...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool {
        ...
        if sourceApplication == "com.spotify.client" {
            // Parse the URL
            let spotifyResponseURLComponents = URLComponents.init(url: url, resolvingAgainstBaseURL: false)!
    ...
    func loginLogic() {
        ...
        AWS.user.login { (task:AWSTask!) -> AnyObject! in
            ...
            if !Spotify.user.authenticated {
                ...
                UIApplication.shared.openURL(Spotify.scopesRequestURL)
            } else {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Tunetag", withExtension: "momd")!
